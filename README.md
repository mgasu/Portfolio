...
| ![image](https://qph.cf2.quoracdn.net/main-qimg-3295051d56c0d0e455d026b5dcfb1bb5.webp) [**In Progress** *Kindle Ad A/B Testing*] | A/B with a Kindle Ad dataset, one fear based ad , one knowledge based ad, I create a predictive model with the goal to determine which add will be more cost effective long-term | Python,  Python, pandas, generating meaningful metrics, two-proportion z-test | 
